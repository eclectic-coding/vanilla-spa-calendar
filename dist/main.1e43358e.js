...
},{}],"src/template.js":[function(require,module,exports) {
"use strict";
...
var controls = function controls(data) {
  var curr = (0, _moment.default)(data.iso);
  var next = (0, _moment.default)(data.iso).add(1, 'month');
  var prev = (0, _moment.default)(data.iso).subtract(1, 'month');
  return html(_templateObject(), prev.format('MM'), prev.format('YYYY'), curr.format('MMMM'), curr.format('YYYY'), next.format('MM'), next.format('YYYY'));
};

var day = function day(data) {
  return html(_templateObject2(), data.iso, (0, _moment.default)(data.iso).format('D'));
};

var calendar = function calendar(data) {
  return html(_templateObject3(), controls(data), data.weekCount, data.days.map(function (data) {
    return day(data);
  }));
};

exports.calendar = calendar;
},{"moment":"node_modules/moment/moment.js"}],"src/views.js":[function(require,module,exports) {
"use strict";
...
},{"./template":"src/template.js"}],"src/model.js":[function(require,module,exports) {
"use strict";
...
var Model = /*#__PURE__*/function () {
  function Model() {
    ...
    this.now = (0, _moment.default)().day(15);
  }
  ...
  _createClass(Model, [{
    ...
    value: function getDays() {
      var days = [];
      var calendarStart = (0, _moment.default)(this.now).startOf('month');
      var calendarEnd = (0, _moment.default)(this.now).endOf('month');
      var timeRange = calendarEnd.valueOf() - calendarStart.valueOf();
      var daysInView = Math.floor(_moment.default.duration(timeRange).asDays());

      for (var i = 0; i <= daysInView; i++) {
        days.push({
          iso: (0, _moment.default)(calendarStart).add(i, 'days').toISOString()
        });
      }
...
},{"moment":"node_modules/moment/moment.js"}],"src/controller.js":[function(require,module,exports) {
"use strict";
...
var App = function App() {
  ...
  var view = new _views.default();
  this.controller = new _controller.default(model, view);
};
...
},{"./util":"src/util.js","./views":"src/views.js","./model":"src/model.js","./controller":"src/controller.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38979" + '/');
